...
using DiskUtility.WindowsAPI.PInvoke.Shlwapi;
using System;
...
namespace DiskUtility.Services.Settings
{
    ...
    public static class LanguageService
    {
        ...
        private static void InitializeLanguageList()
        {
            ...
            {
                LogService.WriteLog(EventLevel.Error, nameof(DiskUtility), nameof(LanguageService), nameof(InitializeLanguageList), 1, e);
