    ...
    public static class LogService
    {
        ...
        public static void OpenLogFolder()
        {
            if (isInitialized)
            {
                Task.Run(() =>
                {
                    ...
                    {
                        WriteLog(EventLevel.Error, nameof(DiskUtility), nameof(LogService), nameof(OpenLogFolder), 1, e);
                    }
                });
            }
        }
        ...
        public static async Task<bool> ClearLogAsync()
        {
            return await Task.Run(() =>
            {
                ...
                {
                    WriteLog(EventLevel.Error, nameof(DiskUtility), nameof(LogService), nameof(ClearLogAsync), 1, e);
                    return false;
                }
            });
        }
